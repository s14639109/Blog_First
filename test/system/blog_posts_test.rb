...
class BlogPostsTest < ApplicationSystemTestCase
  ...
  test "should create blog post" do
    ...
    fill_in "Meta description", with: @blog_post.meta_description
    fill_in "Meta title", with: @blog_post.meta_title
  ...
  test "should destroy Blog post" do
    visit blog_post_url(@blog_post)
    accept_confirm { click_on "Destroy this blog post", match: :first }
